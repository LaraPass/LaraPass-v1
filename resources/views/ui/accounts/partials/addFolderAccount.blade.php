<div class="modal fade" id="add-folder-account" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
        	...
        	<div class="modal-body p-0">
				<div class="card bg-secondary shadow border-0">
				    <div class="card-body px-lg-5 py-lg-5">
				        ...
				        <form role="form" method="POST" action="{{ route('folder.view.accounts.add') }}">
				        	@csrf
				            ...
				            <div class="form-group mb-3">
				                <div class="input-group input-group-alternative">
				                    <input value="{{ $folder->id }}" type="hidden" name="folder" id="folder">
				                    <input class="form-control text-center" value="Adding Account to {{ $folder->name }} Folder" type="text" name="folder_name" id="folder_name" readonly="">
				                </div>
				            </div>
				            <div class="form-group mb-3">
				                <div class="input-group input-group-alternative">
